    ...
    <div className="space-y-24 pb-24">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-4 text-center space-y-8">
          ...
          >
            ...
            <p className="mt-6 text-lg md:text-xl text-black/70 max-w-2xl mx-auto leading-relaxed font-medium">
              দেশপ্রেম ও শৃঙ্খলা
            </p>
          </motion.div>
      ...
      <section id="eligibility" className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">ভর্তির যোগ্যতা ও শর্তাবলী</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              key={i}
              whileHover={{ y: -10 }}
              className="bg-white p-8 rounded-3xl space-y-4 shadow-xl border border-primary/5"
            >
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="bg-white rounded-[2rem] overflow-hidden shadow-2xl border border-primary/5">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-12 space-y-8">
              <div className="flex items-center gap-3">
                <Activity className="w-8 h-8 text-primary" />
                <h2 className="text-3xl font-bold text-black">শারীরিক মানদণ্ড</h2>
              </div>
            ...
            <div className="bg-primary/5 p-12 flex items-center justify-center">
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-black">প্রয়োজনীয় কাগজপত্র</h3>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-black mb-4">নির্বাচন প্রক্রিয়া</h2>
          <div className="w-24 h-1 bg-primary mx-auto rounded-full" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="relative p-8 bg-white rounded-2xl text-center space-y-4 shadow-lg border border-primary/5">
              <span className="absolute top-4 right-4 text-4xl font-black text-black/5">{item.step}</span>
      ...
      {/* Benefits */}
      <section className="max-w-7xl mx-auto px-4">
        <div className="bg-white p-12 rounded-[2rem] shadow-2xl border border-primary/5 bg-gradient-to-br from-primary/5 to-transparent">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold text-black mb-8">বিএনসিসি ক্যাডেট হওয়ার সুবিধাসমূহ</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="flex items-start gap-3">
                  ...
                  <p className="text-black/70 text-sm">{benefit}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="bg-white p-8 rounded-3xl border border-primary/10 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center">
              <Phone className="w-6 h-6 text-primary" />
            </div>
            <div>
              <h3 className="text-xl font-bold text-black">জরুরি প্রয়োজনে</h3>
              <p className="text-black/40 text-sm">প্লাটুন কমান্ডারের সাথে সরাসরি কথা বলতে কল করুন</p>
            </div>
          </div>
          <div className="text-center md:text-right">
            ...
            <p className="text-[10px] text-black/40 uppercase tracking-widest mt-1 font-bold">Platoon Commander</p>
          </div>
        </div>
      </section>
    </div>

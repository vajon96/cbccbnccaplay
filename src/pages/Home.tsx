    ...
    <div className="space-y-24 pb-24">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-4 text-center space-y-8">
          ...
          >
            <Link
              to="/enroll"
              className="group px-8 py-4 bg-primary text-white font-bold rounded-xl flex items-center gap-2 hover:bg-primary/90 transition-all transform hover:scale-105 shadow-lg shadow-primary/20"
            >
      ...
      <section id="eligibility" className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">ভর্তির যোগ্যতা ও শর্তাবলী</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-12 space-y-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-slate-900">শারীরিক মানদণ্ড</h2>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">নির্বাচন প্রক্রিয়া</h2>
          <div className="w-24 h-1 bg-primary mx-auto rounded-full" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="relative p-8 glass rounded-2xl text-center space-y-4">
              <span className="absolute top-4 right-4 text-4xl font-black text-slate-900/5">{item.step}</span>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="glass-card p-8 rounded-3xl border border-olive/10 bg-olive/5 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-900">জরুরি প্রয়োজনে</h3>
              <p className="text-slate-500 text-sm">প্লাটুন কমান্ডারের সাথে সরাসরি কথা বলতে কল করুন</p>
            </div>
          </div>
          <div className="text-center md:text-right">
            ...
            <p className="text-[10px] text-slate-400 uppercase tracking-widest mt-1 font-bold">Platoon Commander</p>
          </div>
        </div>
      </section>
    </div>
